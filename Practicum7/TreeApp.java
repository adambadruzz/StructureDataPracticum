...
public class TreeApp {
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            System.out.print("Enter first letter of show insert, find, delete, traverse, Max, Vmin : ");
            int choice = getChar();
            switch (choice) {
                case 's':
                    theTree.displayTree();
                ...
                case 't':
                    ...
                    break;
                case 'm':
                    System.out.println("Maximum Value : "+theTree.ValueMax(theTree.root));
                    break;
                case 'v':
                    System.out.println("Minimum Value : "+theTree.ValueMin(theTree.root));
                    break;
                default:
